...
public interface BanPingXiaoChengXuGuanLiApi {
     ...
     *
     * @param tianJiaBanPingXiaoChengXuRequest
     */
    TianJiaBanPingXiaoChengXuResponse tianJiaBanPingXiaoChengXu(TianJiaBanPingXiaoChengXuRequest tianJiaBanPingXiaoChengXuRequest);
     ...
     *
     * @param shanChuBanPingXiaoChengXuRequest
     */
    ShanChuBanPingXiaoChengXuResponse shanChuBanPingXiaoChengXu(ShanChuBanPingXiaoChengXuRequest shanChuBanPingXiaoChengXuRequest);
     ...
     *
     * @param quXiaoShouQuanXiaoChengXuRequest
     */
    QuXiaoShouQuanXiaoChengXuResponse quXiaoShouQuanXiaoChengXu(QuXiaoShouQuanXiaoChengXuRequest quXiaoShouQuanXiaoChengXuRequest);
     ...
     *
     * @param huoQuBanPingXiaoChengXuDiaoYongLieBiaoRequest
     */
    HuoQuBanPingXiaoChengXuDiaoYongLieBiaoResponse huoQuBanPingXiaoChengXuDiaoYongLieBiao(HuoQuBanPingXiaoChengXuDiaoYongLieBiaoRequest huoQuBanPingXiaoChengXuDiaoYongLieBiaoRequest);
     ...
     *
     * @param huoQuBanPingXiaoChengXuShouQuanLieBiaoRequest
     */
    HuoQuBanPingXiaoChengXuShouQuanLieBiaoResponse huoQuBanPingXiaoChengXuShouQuanLieBiao(HuoQuBanPingXiaoChengXuShouQuanLieBiaoRequest huoQuBanPingXiaoChengXuShouQuanLieBiaoRequest);

    /**
     * 设置授权方式
     * descr: 调用本接口可以设置半屏小程序授权方式，使用过程中如遇到问题，可在,发帖交流。
     ...
     *
     * @param sheZhiShouQuanFangShiRequest
     */
    SheZhiShouQuanFangShiResponse sheZhiShouQuanFangShi(SheZhiShouQuanFangShiRequest sheZhiShouQuanFangShiRequest);
}