 ...
 */
@Data
@Schema(name = "设置第三方平台服务器域名Request", title = "设置第三方平台服务器域名Request")
public class SheZhiDiSanFangPingTaiFuWuQiYuMingRequest {
    @Schema(title = "接口调用凭证，该参数为 URL 参数，非 Body 参数。使用")
    private String access_token;
    @Schema(title = "操作类型。可选值请看下文")
    private String action;
    @Schema(title = "最多可以添加1000个服务器域名，以;隔开。注意：域名不需带有http:// 等协议内容，也不能在域名末尾附加详细的 URI 地址，严格按照类似 www.qq.com 的写法。")
    private String wxa_server_domain;
