...
//import org.dows.sdk.extract.FieldMetadata;
...
//        }
//
//        FieldMetadata fieldElement = new FieldMetadata();
//
//
...
//    }
//
//    private static FieldMetadata buildFieldElement(List<TreeNode<String>> treeNodes, String pkg, String methodId) {
//        FieldMetadata fieldElement = new FieldMetadata();
//        fieldElement.setPkg(pkg);
//        // 多个参数
//        reduceField(pkg, methodId, fieldElement, treeNodes);
...
//        String pkgId = UUID.fastUUID().toString();
//
//        FieldMetadata fieldElement = (FieldMetadata) elements.get(ElementType.FIELD_ELEMENT);
//        fieldElement.setPkg(pkg);
//        // 多个参数
//        reduceField(pkg, methodId, fieldElement, treeNodes);
//
...
//    }
//
//    private static FieldMetadata getFieldElement() {
//
//        List<FieldMetadata> fieldElements = new ArrayList<>();
//        List<FieldMetadata> fieldElements3 = new ArrayList<>();
//
//        FieldMetadata fieldElement = new FieldMetadata();
...
//
//
//        FieldMetadata f1 = new FieldMetadata();
//        f1.setType("String");
//        f1.setCode("aaa-1");
//        f1.setDescr("测");
//        f1.setIndex(0);
...
//        f2.setDescr("试");
//        f2.setIndex(1);
//        FieldMetadata f3 = new FieldMetadata();
//        f3.setType("Object");
//        f3.setCode("aaa-3");
//        f3.setDescr("测试");
//        f3.setIndex(2);
//
//        FieldMetadata f331 = new FieldMetadata();
//        f331.setType("String");
//        f331.setCode("f331");
//        f331.setDescr("f332");
//        FieldMetadata f332 = new FieldMetadata();
//        f332.setType("String");
//        f332.setCode("f332");
//        f332.setDescr("f332");
//
...
//
//
//    private static void reduceField(String pkg, String parentId, FieldMetadata element, List<TreeNode<String>> treeNodes) {
//
...
//        treeNodes.add(node);
//        // 递归字段
//        List<FieldMetadata> fields = element.getFields();
