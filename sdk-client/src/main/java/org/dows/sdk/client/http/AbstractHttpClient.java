...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    public InputStream download(String url) {
        HttpRequest originRequest = new HttpRequest.Builder().httpMethod(HttpMethod.GET).url(url).build();
    ...
    private void validateResponse(OriginalResponse originalResponse) {
        ...
        if (originalResponse.getBody() != null && !originalResponse.getBody().isEmpty()
