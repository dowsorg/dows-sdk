...
public final class HttpResponse<T> {
    ...
    public static class Builder<T> {
        ...
        public HttpResponse<T> build() {
            ...
            if (originalResponse.getBody() == null || originalResponse.getBody().isEmpty() || serviceResponseType == null) {
            ...
            T serviceResponse;
            try {
                serviceResponse = GsonUtil.getGson().fromJson(originalResponse.getBody(), serviceResponseType);
